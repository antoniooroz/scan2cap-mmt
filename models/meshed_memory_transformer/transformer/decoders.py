...
from models.meshed_memory_transformer.transformer.utils import sinusoid_encoding_table, PositionWiseFeedForward
from models.meshed_memory_transformer.containers import Module, ModuleList
...
class MeshedDecoder(Module):
    ...
    def forward(self, data_dict, encoder_output, mask_encoder):
        ...
        out = self.fc(out)
        data_dict["lang_cap"] = F.log_softmax(out, dim=-1)
