...
from models.meshed_memory_transformer.containers import Module
from models.meshed_memory_transformer.beam_search import *
...
class CaptioningModel(Module):
    ...
    def beam_search(self, data_dict, max_len: int, eos_idx: int, beam_size: int, out_size=1,
                    return_probs=False, **kwargs):
        bs = BeamSearch(self, max_len, eos_idx, beam_size)
        return bs.apply(data_dict, out_size, return_probs, **kwargs)
