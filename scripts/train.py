...
def get_solver(args, dataset, dataloader):
    ...
    if args.use_rl:
        ...
        optimizer = optim.AdamW(model.parameters(), lr=args.lr, betas=(0.9, 0.98), weight_decay=args.wd)    
...
if __name__ == "__main__":
    ...
    parser.add_argument("--d_model", type=int, default=128, help="Internal MMT feature dimension")
    parser.add_argument("--attention_module_memory_slots", type=int, default=40, help="Amount of memory slots in MMT Encoder")
    parser.add_argument("--max_len", type=int, default=32, help="Max length of sentences generated by Beam Search and Iterative Search")
    parser.add_argument("--decoder_layers", type=int, default=3, help="Number of MMT Decoder layers")
    parser.add_argument("--transformer_d_k", type=int, default=64, help="MMT key dimension")
    parser.add_argument("--transformer_d_v", type=int, default=64, help="MMT value dimension")
    parser.add_argument("--transformer_h", type=int, default=8, help="MMT attention heads")
    parser.add_argument("--transformer_d_ff", type=int, default=2048, help="MMT fully connected layers")
    parser.add_argument("--transformer_dropout", type=float, default=0, help="Dropout in MMT Encoder and Decoder")
    parser.add_argument("--no_beam_search", action="store_true", help="Disables Beam Search for Evaluation (Uses Iterative Search instead)")
