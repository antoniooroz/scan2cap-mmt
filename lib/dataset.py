...
class ScannetReferenceDataset(ReferenceDataset):
    ...
    def __init__(self, scanrefer, scanrefer_all_scene, 
        ...
        use_random_cuboid = False,  # TODO: Try out this data-augmentation method
    ...
    def __getitem__(self, idx):
        ...
        # Not an option in 3detr #todo: find a good fail-safe strategy. either remove from args or smth similar.
        if self.use_normal:
