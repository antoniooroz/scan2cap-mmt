...
# path
CONF.PATH = EasyDict()
CONF.PATH.BASE = "/home/antonio/Dropbox/projects/TUM/ADL4CV/scan2cap-with-transformers/" # TODO: change this
CONF.PATH.CLUSTER = "/home/antonio/Dropbox/projects/TUM/ADL4CV/scan2cap-with-transformers/" # TODO: change this
CONF.PATH.DATA_EXT = "/media/antonio/Secondary Drive/ADL4CV_DATA/" # TODO: change this
CONF.PATH.DATA = os.path.join(CONF.PATH.DATA_EXT, "data")
...
# data
CONF.SCANNET_DIR = CONF.PATH.SCANNET_SCANS # TODO change this
CONF.SCANNET_FRAMES_ROOT = os.path.join(CONF.PATH.DATA, "scannet_images/scannet_train_images/frames_square") # TODO change this
CONF.PROJECTION = os.path.join(CONF.PATH.DATA, "multiview_projection_scanrefer") # TODO change this
